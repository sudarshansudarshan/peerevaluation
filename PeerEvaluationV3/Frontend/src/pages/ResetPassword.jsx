...
import { FaEye, FaEyeSlash, FaCheck, FaTimes, FaHome, FaLock } from 'react-icons/fa';
...
export default function ResetPassword() {
    ...
    const handleReset = async (e) => {
        ...
        try {
            ...
            showMessage(err.response?.data?.message || 'Invalid or expired token!', 'error');
        } finally {
            setLoading(false);
        }
    };
            ...
            <div style={{
                ...
                <form onSubmit={handleReset} className="reset-password-form">
                    ...
                    <div className="form-group">
                        <label style={{ textAlign: 'center', width: '100%' }} htmlFor="password">New Password</label>
                    ...
                    {/* Confirm Password */}
                    <div className="form-group">
                        <label style={{ textAlign: 'center', width: '100%' }} htmlFor="confirmPassword">Confirm New Password</label>
                        <div className="input-wrapper">
                            <input
                                id="confirmPassword"
